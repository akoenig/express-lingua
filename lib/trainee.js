...
module.exports = (function() {
    ...
    Trainee.prototype.persistCookie = function(req, res, locale) {
        ...
        this.configuration.storage.options.expires = this.configuration.storage.options.expires ?
                                                        this.configuration.storage.options.expires :
                                                        expirationDate;

        cookies.set(this.configuration.storage.key, locale, this.configuration.storage.options);
    };
