...
module.exports = function(app, options) {
    ...
    var guru = {
        ...
        //
        determine : function(querystrings, cookies, headers) {
            if(querystrings.query.lingua) {
                return querystrings.query.lingua;
            }

            if(cookies.get('lingua')) {
                return cookies.get('lingua');
            }
    ...
    return function lingua(req, res, next) {
        ...
        var locale = guru.determine(querystrings, cookies, headers);

        var expirationDate = new Date();
        expirationDate.setFullYear(expirationDate.getFullYear() + 1);
        cookies.set('lingua', locale, { expires: expirationDate });
